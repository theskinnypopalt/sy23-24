...
Partial Class UserControl1
    ...
    Private Sub InitializeComponent()
        ...
        Me.ImageList1.Images.SetKeyName(0, "6677590.png")
        Me.ImageList1.Images.SetKeyName(1, "video_slot_machine_symbols_7_thumbnail_square_0000.jpg")
        Me.ImageList1.Images.SetKeyName(2, "download.png")
        '
        'UserControl1
        '
